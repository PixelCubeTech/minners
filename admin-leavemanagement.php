...
<table border="1" align="center">
	  <tr>
		...
		<th bgcolor="#96F6FF">Email id</th>
		  ...
		  <th bgcolor="#96F6FF">Accept / Deny</th>
	  </tr>
			<?php
			$i=0;
	  ...
	  <tr>
		...
		<td><a href="admin-leave.php?id=<?php echo $rows["Emp_ID"]; ?>">Update info</a></td>
      </tr>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="authentication.php" method="post">
    <div class="imgcontainer">
      ...
      <img src="images/img_568656.png" alt="Avatar" class="avatar">
    </div>
